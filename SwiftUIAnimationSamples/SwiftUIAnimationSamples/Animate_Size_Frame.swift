...
struct Animate_Size_Frame: View {
    ...
    var body: some View {
        VStack {
            ...
            BannerText("Notice ho this changes the layout of the screen. You may want to consider animating with the scaleEffect instead.", backColor: .blue, textColor: .white)
        }.font(.title)
    }
}
